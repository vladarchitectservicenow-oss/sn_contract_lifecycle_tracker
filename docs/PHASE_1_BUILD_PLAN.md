...
**Repository:** sn_contract_lifecycle_tracker
...
Build a production-ready ServiceNow scoped application that end-to-end contract lifecycle management within servicenow, tracking creation, negotiation, approval, execution, renewal, and archival with automated sla and compliance alerts.. The application must be installable on any Australia-era ServiceNow instance and must pass automated functional tests with zero external runtime dependencies.
